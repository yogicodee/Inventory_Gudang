                                ...
                                {filteredProducts.map(p => (
                                    <tr key={p.id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="p-3 text-center">
                                            <span className={`px-2 py-0.5 text-[10px] font-bold rounded ${p.current_stock < 20
                                ...
                                {filteredProducts.map(p => {
                                    ...
                                    return (
                                        <tr key={p.id} className="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className="p-3 text-center">
                                                <span className={`px-2 py-0.5 text-[9px] font-bold rounded ${isMarginHealthy ? 'bg-emerald-50 text-emerald-700 border border-emerald-100' : 'bg-rose-50 text-rose-700 border border-rose-100'
                                                    }`}>
